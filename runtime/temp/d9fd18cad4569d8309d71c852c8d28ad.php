<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"F:\www\public/../application/index\view\part\update.html";i:1545968333;s:48:"F:\www\application\index\view\public\header.html";i:1545208666;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="pid" name="pid" class="valid">
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($res['pid'] == $vo['id']): ?>
                    <option value="<?php echo $vo['id']; ?>" selected="selected"><?php echo str_repeat('&nbsp;─│&nbsp;',$vo['level']); ?><?php echo $vo['name']; ?></option>
                    <?php else: ?>
